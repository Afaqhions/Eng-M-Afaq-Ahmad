      ...
      <section class="py-16 px-4 sm:px-6 lg:px-20">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* <!-- Project 1: React --> */}
            <div class="border-2 border-[#8245ec] rounded-lg shadow hover:shadow-xl transition duration-300 p-6">
            ...
            <div class="border-2 border-[#8245ec] rounded-lg shadow hover:shadow-xl transition duration-300 p-6">
              ...
              <p class="text-sm text-[#fff] mb-4">
                A full-stack chatbot application having AI's for Study, Coding,
                Health and for general use using Django and Sqlite3 with
            ...
            <div class="border-2 border-[#8245ec] rounded-lg shadow hover:shadow-xl transition duration-300 p-6">
              ...
              <p class="text-sm 0 text-[#fff] mb-4">
                ...
                predict whether a message or an email is Spam or not from
                dataset features.
              </p>
